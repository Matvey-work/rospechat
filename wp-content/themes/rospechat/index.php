        ...
        <div class="container">
          ...
          <div class="our-team__list">
            <div class="our-team__item">
              <img src="./img/elena.jpg" alt="" class="our-team__img" width="270px" height="280px">
              <p class="our-team__name">Елена Сверидова</p>
              <p class="our-team__position">Менеджер по печати</p>
            </div>
            <div class="our-team__item">
              <img src="./img/oleg.jpg" alt="" class="our-team__img" width="270px" height="280px">
              <p class="our-team__name">Олег Крепенко</p>
              <p class="our-team__position">Расчетный менеджер</p>
            </div>
            <div class="our-team__item">
              <img src="./img/ekaterina.jpg" alt="" class="our-team__img" width="270px" height="280px">
              <p class="our-team__name">Екатерина Петрова</p>
              <p class="our-team__position">Ведущий маркетолог</p>
            </div>
            <div class="our-team__item">
              <img src="./img/alexander.jpg" alt="" class="our-team__img" width="270px" height="280px">
      ...
      <section class="production">
        <!-- <div class="container"> -->
          ...
          <div class="production__slider-container sliders">
            ...
            <div class="slider-img"><img src="./img/slider-foto3.jpg" alt=""></div>
            <div class="slider-img"><img src="./img/slider-foto2.jpg" alt=""></div>
            <div class="slider-img"><img src="./img/slider-foto1.jpg" alt=""></div>
            <div class="slider-img"><img src="./img/slider-foto1.jpg" alt=""></div>
            <div class="slider-img"><img src="./img/slider-foto1.jpg" alt=""></div>
            <div class="slider-img"><img src="./img/slider-foto1.jpg" alt=""></div>
            <div class="slider-img"><img src="./img/slider-foto1.jpg" alt=""></div>
